...
// 256px WebP, not the PNG masters: ProjectLogo draws these in a 40px box, and
// the OpenNext/Cloudflare deploy has no image optimizer, so whatever is on disk
// is what ships. See the note in Apps.tsx.
import logoDiy from '@/images/projects/diy.webp'
import logoParra from '@/images/projects/parra.webp'
import logoMojo from '@/images/projects/mojo.webp'
